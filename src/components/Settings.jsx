...
import './Settings.css';
import businessLogo from '../assets/Ht-logo.png';
...
function Settings() {
  ...
  const [logo] = useState(businessLogo);
  ...
  const [users, setUsers] = useState([
    {
      id: 1,
      name: 'Kenzo Rafael',
      email: 'admin1@happytails.com',
      username: 'SkerlyyB05',
      role: 'Manager',
      joinedDate: '01/01/2005'
    },
    {
      id: 2,
      name: 'Schenly Rein',
      email: 'admin2@happytails.com',
      username: 'SkerlyyB05',
      role: 'Staff',
      joinedDate: '01/01/2005'
    },
    ...
    <div className="settings-container">
            ...
            <div className="business-layout">
              ...
              <div className="business-right">
                <div className="logo-section">
                  <div className="logo-placeholder" aria-label="Business logo">
                    <img src={logo} alt="Happy Tails Pet Cafe Logo" />
                  </div>
                  <div className="business-name">Happy Tails Pet Cafe</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {isAddUserModalOpen && (
        <div className="modal-overlay" onClick={() => setIsAddUserModalOpen(false)}>
          <div className="modal-content" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="add-user-title">
            ...
            <form onSubmit={handleAddUser}>
              ...
              <div className="modal-actions">
                <button type="button" className="cancel-btn" onClick={() => setIsAddUserModalOpen(false)}>
                  Cancel
                </button>
      ...
      {isEditUserModalOpen && editingUser && (
        <div className="modal-overlay" onClick={() => setIsEditUserModalOpen(false)}>
          <div className="modal-content" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="edit-user-title">
            <div className="modal-header">
            ...
            <form onSubmit={handleUpdateUser}>
              ...
              <div className="modal-actions">
                <button type="button" className="cancel-btn" onClick={() => setIsEditUserModalOpen(false)}>
                  Cancel
                </button>
                <button type="submit" className="save-btn">
                  Update User
